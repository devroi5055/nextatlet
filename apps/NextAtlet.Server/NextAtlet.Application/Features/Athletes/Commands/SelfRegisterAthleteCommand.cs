...
public class SelfRegisterAthleteCommandHandler
    : AthleteRegistrationHandlerBase, IRequestHandler<SelfRegisterAthleteCommand, Result<SiteDto>>
{
    ...
    public async Task<Result<SiteDto>> Handle(SelfRegisterAthleteCommand request, CancellationToken cancellationToken)
    {
