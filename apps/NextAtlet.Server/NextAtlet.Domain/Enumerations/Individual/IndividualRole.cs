...
public sealed class ProfileRoles : Enumeration
{
    public static readonly ProfileRoles AthleteOwner = new()
    {
        Id = "athlete_owner",
    ...
    public static readonly ProfileRoles Guardian = new()
    {
        Id = "guardian",
    ...
    public static IReadOnlyCollection<ProfileRoles> All => [AthleteOwner, Guardian];

    public static ProfileRoles FromId(string id) =>
