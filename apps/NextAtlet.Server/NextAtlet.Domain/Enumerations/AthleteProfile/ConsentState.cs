...
/// </summary>
public sealed class ConsentState : Enumeration
{
    public static readonly ConsentState NotRequired = new()
    {
        Id = "not_required",
    ...
    public static readonly ConsentState PendingGuardianConsent = new()
    {
    ...
    public static readonly ConsentState Consented = new()
    {
        Id = "consented",
    ...
    public static IReadOnlyCollection<ConsentState> All => [NotRequired, PendingGuardianConsent, Consented];

    public static ConsentState FromId(string id) =>
